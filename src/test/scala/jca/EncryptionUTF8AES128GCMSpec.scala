...
class EncryptionUTF8AES128GCMSpec extends AnyFlatSpec with should.Matchers {
    ...
    // TODO merge this with EncryptionUTF8AES128CTRSpec
    ...
    it should "decryptRow2" in {
        ...
        val wi: IO[String] = HexEncryption.decryptRow(keyMap)(row)
        wi.handleError { case _: EncryptionException => true }.unsafeRunSync() shouldBe true
    }

    it should "decryptRow2a" in {
        val keyMap = Map("1" -> "k0JCcO$SY5OI50uj")
        val row = Seq("2", "")
        a[EncryptionException] shouldBe thrownBy(HexEncryption.decryptRow(keyMap)(row).unsafeRunSync())
    }
