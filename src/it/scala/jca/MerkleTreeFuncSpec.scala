...
class MerkleTreeFuncSpec extends AsyncFreeSpec with AsyncIOSpec with should.Matchers {
    ...
    "MerkleTreeFunc" - {
        ...
        "apply" in {
            ...
            val resultIO: IO[Option[(Bytes, Bytes)]] = MerkleTree.mineMerkleTreeBlock(transactions, priorBlockHash, 5)(checkBlockHash)(RandomState(1L))
            resultIO.asserting {
